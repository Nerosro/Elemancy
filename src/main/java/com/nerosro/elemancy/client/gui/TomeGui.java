package com.nerosro.elemancy.client.gui;
...
/**
 * Created by Nerosro on 23/02/2018.
 */

public class TomeGui extends GuiScreen {
    //Gui can only be 256x256!

    private final ResourceLocation tomeBackground = new ResourceLocation(Reference.MODID, "textures/gui/gui_tome.png");
    private final ResourceLocation elements1 = new ResourceLocation(Reference.MODID, "textures/gui/elements1.png");
    private final ResourceLocation elements2 = new ResourceLocation(Reference.MODID, "textures/gui/elements2.png");
    ...
    public void initGui() {
        ...
        buttonList.add(button1=new ButtonGui(BTNAIR, btnX,centerY));
        buttonList.add(button1=new ButtonGui(BTNEARTH, btnX,centerY+iconBtnH));
        buttonList.add(button1=new ButtonGui(BTNWATER, btnX,centerY+iconBtnH*2));
        buttonList.add(button1=new ButtonGui(BTNFIRE, btnX,centerY+iconBtnH*3));
        buttonList.add(button1=new ButtonGui(BTNDARK, btnX,centerY+iconBtnH*4));
        buttonList.add(button1=new ButtonGui(BTNLIGHT, btnX,centerY+iconBtnH*5));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if(varSwitch==0)
        {
            fontRenderer.drawString(Reference.WELCOME_TEXT, (width/2)-Reference.WELCOME_TEXT.length()-25, centerY+20, 0x000000);
        }
        else
        {
            GlStateManager.pushMatrix();
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id){
            case BTNHOME:
                //TODO find a way to add a home button
                break;
            case BTNAIR:
                drawIcon(elements1,0,0);
                break;
            case BTNEARTH:
